...
const jshint = require('gulp-jshint'),
    ...
    mongoExeUri = 'MONGO-EXE-URL',
    mongoStorageUri = 'MONGO-STORE-URL',
        ...
        if (process.platform == 'win32' && process.env.USERNAME == 'Newms') {
            ...
            ps.lookup({
                ...
                if (!f.length) {
                    ...
                    kid.exec(`c: && cd ${mongoExeUri} && start mongod -dbpath "${mongoStorageUri}" && pause`, function (err, stdout, stderr) {
